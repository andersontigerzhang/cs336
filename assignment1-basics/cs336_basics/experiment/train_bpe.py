...
Options:
  ...
  --data=<data>            input file [default: data/TinyStoriesV2-GPT4-valid.txt]
  --output_vocab=<out>     output for vocab [default: output/tinystories_vocab.json]
  --output_merges=<out>    output for merges [default: output/tinystories_merges.txt]
